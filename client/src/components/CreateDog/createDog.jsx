...
import { getTemperments, postDog } from "../../redux/actions";
      ...
      <form onSubmit={handleSubmit} className="form_info-Container">
        <div className="form_info">
          <h3 className="form_title">
            <span className="title_">Create your puppy!</span>{" "}
          </h3>
          ...
          <input
            ...
            className="form_input"
          />
          {error.life_expectancy && (
            <p className="error_text">{error.life_expectancy}</p>
          )}
...
function validate(input) {
  ...
  if (!input.minHeight || !input.maxHeight) {
    ...
    error.minWeight =
      "Check the numbers, can't be negative and greater than 200cm";
  }
  ...
  if (!input.maxWeight || !input.minWeight) {
    ...
    error.minWeight =
      "Check the numbers, can't be negative and greater than 120 kg";
  }
